...
PROFILES: Dict[str, DirectionProfile] = {
    "modern": DirectionProfile(
        ...
        offense_w={
            ...
            "DHO_Chicago": 0.12,
            "Transition_Early": 0.11,
            "Horns_Elbow": 0.11,
            "Post_InsideOut": 0.10,
        },
        defense_w={
            "Drop": 0.24,
            "Switch_Everything": 0.19,
            "Hedge_ShowRecover": 0.13,
            "Switch_1_4": 0.12,
            "Blitz_TrapPnR": 0.11,
            "Zone": 0.11,
            "AtTheLevel": 0.10,
    ...
    "motion": DirectionProfile(
        name="motion",
        offense_w={
            "Motion_SplitCut": 0.17,
            "DHO_Chicago": 0.15,
            "FiveOut": 0.13,
            "Spread_HeavyPnR": 0.12,
            "Drive_Kick": 0.12,
            "Horns_Elbow": 0.11,
            "Transition_Early": 0.10,
            "Post_InsideOut": 0.10,
        },
        defense_w={
            "Switch_Everything": 0.21,
            "Drop": 0.20,
            "Switch_1_4": 0.13,
            "Zone": 0.13,
            "AtTheLevel": 0.12,
            "Hedge_ShowRecover": 0.11,
            "Blitz_TrapPnR": 0.10,
        },
        off_sharp_mu=1.08,
        off_str_mu=1.04,
    ...
    "pace": DirectionProfile(
        name="pace",
        offense_w={
            "Transition_Early": 0.17,
            "Drive_Kick": 0.15,
            "Spread_HeavyPnR": 0.14,
            "FiveOut": 0.12,
            "Motion_SplitCut": 0.12,
            "DHO_Chicago": 0.10,
            "Horns_Elbow": 0.10,
